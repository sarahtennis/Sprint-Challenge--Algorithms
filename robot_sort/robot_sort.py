...
class SortingRobot:
    ...
    def sort(self):
        ...
        # [3!, 2, 1] hold None SWAP
        # [None!, 2, 1] hold 3, MOVE RIGHT
        # [None, 3!, 1] hold 2, SWAP
        # [2!, 3, 1] hold None, MOVE LEFT, SWAP
        # [2, 3!, 1] hold None, MOVE RIGHT
        # [2, None, 1!] hold 3, SWAP, MOVE RIGHT
        # [2, None!, 3] hold 1 MOVE LEFT
        # [2, 1, 3!] hold None, can't move right

        # [2!, 2, 1] hold None SWAP, MOVE RIGHT
        # [None, 2!, 1] hold 2, MOVE LEFT SWAP MOVE RIGHT
        # [2, 2!, 1] hold None, SWAP MOVE RIGHT
